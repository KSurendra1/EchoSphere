...
export const HeartIcon: React.FC<IconProps> = ({ filled = false, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill={filled ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export const SettingsIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.226.554-.22 1.198-.033 1.634.331l6.666 6.666c.364.364.552.87.552 1.386 0 .517-.188 1.022-.552 1.386l-6.666 6.666c-.436.364-1.08.552-1.634.331-.55-.22-1.02-.684-1.11-1.226l-.828-4.968a2.25 2.25 0 00-2.172-1.859H5.25a2.25 2.25 0 00-2.172 1.859l-.828 4.968c-.09.542-.56 1.007-1.11 1.226-.554-.22-1.198-.033-1.634-.331L.828 15.122c-.364-.364-.552-.87-.552-1.386 0-.517.188 1.022.552-1.386L7.494 5.7c.436-.364 1.08-.552 1.634-.331.55.22 1.02.684 1.11 1.226l.828 4.968A2.25 2.25 0 0013.5 12h.75a2.25 2.25 0 002.172-1.859l.828-4.968z" />
  </svg>
);

export const ChatbotIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.455.09-.934.09-1.425v-2.125c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
    </svg>
);
